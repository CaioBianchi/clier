...
class ProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should update profile' do
    patch profile_url,
          params: { user: { first_name: 'New', last_name: 'Name', location: 'New Location', bio: 'New Bio' } }
  ...
  test 'should update password with valid challenge' do
    patch password_profile_url,
          params: { user: { password_challenge: 'password', password: 'newpassword',
  ...
  test 'should not update password with invalid challenge' do
    patch password_profile_url,
          params: { user: { password_challenge: 'wrongpassword', password: 'newpassword',
                            password_confirmation: 'newpassword' } }
    assert_redirected_to edit_profile_url
